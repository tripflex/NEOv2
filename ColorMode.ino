...
{// void CCreturnAndSave
	...
	{// if ONCE_RESET_COLOR_MODES
		...
		if (VARIATION)
		{
			...
			ModeSetSRAM [ModeToChange][19] = 0; // CC palette variation 1		
		}
		else
		{
			ColorMaxCount[0] = 0;// variation 0
			ModeSetSRAM [ModeToChange][0] = (ColorToSave+1);// Max Colors variation 0
			ModeSetSRAM [ModeToChange][1] = 0; // CC palette variation 0
		}
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{// if ONCE_SAVE_COLOR
		...
		noInterrupts();
		// save the color here
		CCSET = 0;// replace with current color set value
		...
		ModeSetSRAM [ModeToChange][(VariationOffset+1)] = 0;// Color Palette
